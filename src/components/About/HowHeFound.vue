<template>
  <div class="text-secondary flex flex-col gap-5">
    ...
    >
      ...
      web-based system. The first system he developed was a Student Information
      System.
    </p>
    ...
    >
      ...
      overseeing the integration of their Enterprise Integration System (EIS).
      The system he developed was a Human Resource Management System, which
      handled tasks such as hiring, processing applicants’ requirements,
      conducting interviews, and more. It took him almost three months to
      develop this system.
    </p>
  </div>
</template>
