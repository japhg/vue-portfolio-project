            ...
            <div class="max-w-3xl mx-auto">
                ...
                <div class="space-y-5">
                    ...
                    <p
                        ...
                        data-aos-duration="600"
                    >
                        I'm a Full-Stack Web Developer with strong expertise in both front-end and
                        back-end technologies. Experienced in building dynamic, responsive, and
                        user-friendly web applications using modern frameworks.
                    </p>
                </div>
                ...
                <!-- Tech Stack -->
                <div
                    class="flex flex-wrap gap-2 mt-12"
                    data-aos="fade-up"
                    data-aos-delay="800"
                    data-aos-duration="600"
                >
